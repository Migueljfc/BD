...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        {
            return new SqlConnection("data source= DESKTOP-TB868K4\\SQLEXPRESS;integrated security=true;initial catalog=Northwind");
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM Customers WHERE CustomerID=@contactID", cn);
            cmd.Parameters.AddWithValue("@contactID", txtID.Text);
            SqlDataReader reader = cmd.ExecuteReader();
            cmd.Parameters.Clear();
            listBox1.Items.Clear();
